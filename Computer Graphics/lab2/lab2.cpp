...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0, 0, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(2, 1, 8), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(78, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
...

    {
        ...
        {
            VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 0, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(-1, 1, 0), glm::vec3(0, 0, 1), glm::vec3(0.0, 0.0, 0.0)),
        };

        vector<unsigned int> indices2 =
        {
            2, 0, 1,   // indices for first triangle
            3, 2, 0,  // indices for second triangle
            // TODO(student): Complete indices data for the cube mesh
...

    {
        ...
        {
            VertexFormat(glm::vec3(-4.16, 0 ,0), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(0, -4, 0), glm::vec3(0, 0, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(1.39, 1.6, 0), glm::vec3(1, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
            VertexFormat(glm::vec3(-0.92, -0.8, 4.71), glm::vec3(0, 1, 1), glm::vec3(0.0, 0.0, 0.0)),
        ...
        // Actually create the mesh from the data
        CreateMesh("tetra", vertices1, indices1);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 1), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(2, 2, 2), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(0.25f));
