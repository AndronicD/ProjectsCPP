...
namespace implemented
{
    ...
    public:
        MyCamera()
        {
            ...
            distanceToTarget = glm::length(glm::vec3(1, 1, 1));
        }
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 newVec = glm::vec4(glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1.0));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 newVec = glm::vec4(glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1.0));
            forward = glm::normalize(glm::vec3(newVec));

            newVec = glm::vec4(glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1.0));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 newVec = glm::vec4(glm::rotate(glm::mat4(1.0f), angle, forward) * glm::vec4(right, 1.0));
            right = glm::normalize(glm::vec3(newVec));
            up = glm::normalize(glm::cross(right, forward));
        }
        ...
        void RotateThirdPerson_OY(float angle)
        {
            // TODO(student): Rotate the camera in third-person mode around
            // the OY axis.
            TranslateForward(distanceFromCar);
        ...
        void CalculatePos(float vert, float horiz, float rot, glm::vec3 playPos) {
            float offX = horiz * sin(rot);
            float offZ = horiz * cos(rot);
            position.x = playPos.x - offX;
            position.y = playPos.y + vert;
            position.z = playPos.z - offZ;
            yaw = 180 - rot;
        }
